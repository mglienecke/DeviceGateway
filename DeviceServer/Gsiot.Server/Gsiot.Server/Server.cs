...
namespace Gsiot.Server
{
    ...
    {
        private const int DelayTimeOnClose = 1000;

        private bool mAcceptConnections = false;
        ...
        /// <summary>
        /// The method stops the handling of the incoming connections.
        /// </summary>
        public void Pause()
        {
            mAcceptConnections = false;
        ...
        public void Run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    if (mAcceptConnections)
                    {
                        do
                        {
                            ...
                            {
                                Debug.Print("UNCAUGHT EXCEPTION: " + exc.ToString());
                ...
                {
                    Debug.Print("Exception while accepting connections: " + exc.ToString());
                }
            }
        }
