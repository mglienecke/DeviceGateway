...
@"<GetMultipleSensorDataResult>
   ...
   <SensorDataList>{1}</SensorDataList>
        ...
        public string CreateGetErrorLogResponseContent(ICollection errorLog)
        {
            ...
            return String.Format(XmlDocTemplate, String.Format(ErrorLogEntriesResponseTemplate, builder.ToString()));
        }
        ...
        {
            return String.Format(SensorDataTemplate, data.GeneratedWhen.ToString("yyyy-MM-dd HH:mm:ss.fff"), data.Value, data.SensorId, data.CorrelationId);
        }
        ...
        public string CreateGetLastSensorValuesResponse(Sensor sensor)
        {
            ...
            return String.Format(GetSensorDataResultTemplate, 
                String.Format(OperationResultElementsTemplate, "true", String.Empty),
        ...
        {
            return String.Format(GetMultipleSensorDataResultTemplate, 
                String.Format("true", String.Empty), 
        ...
        {
            return String.Format(OperationResultResponseTemplate, success.ToString().ToLower(), message);
        }
        ...
        internal static void FillInEncodedSensorValueList(StringBuilder result, Sensor sensor)
        {
            ...
            result.AppendLine(String.Format(SensorDataTemplate, data.GeneratedWhen.ToString("yyyy-MM-dd HH:mm:ss.fff"), data.Value, data.CorrelationId));
            ...
            if (sensor.StoredValues != null)
            {
                ...
                {
                    result.AppendLine(String.Format(SensorDataTemplate, data.GeneratedWhen.ToString("yyyy-MM-dd HH:mm:ss.fff"), nextData.Value, data.CorrelationId));
                }
            }
        }
